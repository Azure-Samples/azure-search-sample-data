...
1. Save this file as get_index_stats.java.
2. Run:
	javac get_index_stats.java -cp .;gson-2.8.1.jar -encoding UTF-8
3. Run:
	java -cp .;gson-2.8.1.jar get_index_stats
*/

public class get_index_stats {
...
// Replace this with a valid subscription key.
	...
	static String operation = "/indexes/" + index_name + "/stats";
