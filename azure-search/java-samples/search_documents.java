...
1. Save this file as search_document.java.
2. Run:
	javac search_document.java -cp .;gson-2.8.1.jar -encoding UTF-8
3. Run:
	java -cp .;gson-2.8.1.jar search_document
*/
...
// Replace this with a valid subscription key.
	...
	static String operation = "/indexes/" + index_name + "/docs/search";
