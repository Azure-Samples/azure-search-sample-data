...
1. Save this file as analyze_text.java.
2. Run:
	javac analyze_text.java -cp .;gson-2.8.1.jar -encoding UTF-8
3. Run:
	java -cp .;gson-2.8.1.jar analyze_text
*/

public class analyze_text {
...
// Replace this with a valid subscription key.
	...
	static String operation = "/indexes/" + index_name + "/analyze";
