...
1. Save this file as lookup_document.java.
2. Run:
	javac lookup_document.java -cp .;gson-2.8.1.jar -encoding UTF-8
3. Run:
	java -cp .;gson-2.8.1.jar lookup_document
*/

public class lookup_document {
...
// Replace this with a valid subscription key.
	...
	static String document_key = "1";
	static String host = service_name + ".search.windows.net";
	static String operation = "/indexes/" + index_name + "/docs/" + document_key;
