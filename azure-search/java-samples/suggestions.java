...
1. Save this file as suggestions.java.
2. Run:
	javac suggestions.java -cp .;gson-2.8.1.jar -encoding UTF-8
3. Run:
	java -cp .;gson-2.8.1.jar suggestions
*/
...
// Replace this with a valid subscription key.
	...
	static String operation = "/indexes/" + index_name + "/docs/suggest";
