...
1. Save this file as add_document.java.
2. Run:
	javac add_document.java -cp .;gson-2.8.1.jar -encoding UTF-8
3. Run:
	java -cp .;gson-2.8.1.jar add_document
*/
...
// Replace this with a valid subscription key.
	...
	static String operation = "/indexes/" + index_name + "/docs/index";
	...
	public static String index = "{" +
		"'value': [" +
			"{" +
				...
				"'Data': 'This field contains test data.'" +
			"}" +
		"]" +
	"}";
